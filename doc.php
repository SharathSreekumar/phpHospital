...
<body>
	...
	<div class="row">
		<div class="container col-lg-4"></div>
		<div class="container col-lg-4">
			<form action="doc.php" method="post" class="form-inline" role="search">
    			...
    			if($result->num_rows > 0) {// if row > 0, then 'n' data exists
					...
					while($row = $result->fetch_assoc()) {
        				...
        				$resultI = $con->query($queryI);
  						...
  						// //Edit button directs the page to Update option
  						//View report directs to viewing the details of the Patient
  						echo "<td class=\"col-lg-1\"><p style=\"text-align:center;vertical-align:top;\"><button class=\"btn\" type=\"submit\" formaction=\"reportDetDoc.php\" name=\"viewme\" value=\"". $row['npid1'] ."\">View Report</button></p></td>";
  						echo "</tr>";
					}
				}
				$con->close();
